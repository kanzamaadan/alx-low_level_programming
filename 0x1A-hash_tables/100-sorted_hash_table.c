 ...
 * @ht:this pointer to sorted hash table.
 * @key: key to add - can't be empty str.
...
/**
 * shash_table_get -this retrieve val associated with
 *                   key in a sorted hash table.
 * @ht:this pointer to sorted hash table.
 * @key: This key to get the val of.
 * Return: NULL If the key cannot be matched 
 *         Otherwise - val associated with key in ht.
 */
char *shash_table_get(const shash_table_t *ht, const char *key)
{
shash_node_t *node;
 ...
 * @ht:this pointer to the sorted hash table.
 */
void shash_table_print(const shash_table_t *ht)
{
shash_node_t *node;
 ...
 * @ht: this pointer to the sorted hash table to print.
 */
void shash_table_print_rev(const shash_table_t *ht)
{
shash_node_t *node;
